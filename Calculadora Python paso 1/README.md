# Calculadora Básica en Python - Parte 1

## Descripción

Esta primera parte del proyecto consiste en el análisis, diseño e implementación inicial de una calculadora básica en Python. Para ello se elaboraron diagramas de flujo que representan la lógica del programa,y ademas se configuró el repositorio digital Github.
...
- Diagrama de flujo general de una calculadora basica.
- Diagrama IPO (Entrada - Proceso - Salida).
- Diagrama de secuencia de interacción entre el usuario y el sistema.
